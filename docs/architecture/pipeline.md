...
1. **Профиль ширины маски** (~85-90% портретов) — анализирует ширину маски субъекта по вертикали. Первый локальный максимум ширины сверху = уровень скул → зона лица. Быстро (~1ms), 0 зависимостей
