...
Степень сглаживания контура настраивается через `contour_smooth_epsilon` в config.yaml. Значение 0.001 — минимальное (ближе к оригиналу), 0.005 — агрессивное (сглаживает мелкие детали типа прядей волос).
