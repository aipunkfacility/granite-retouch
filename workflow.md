# granite-retouch Agentic Workflow
...
5. **Ретушь (Photoshop):**
   - Выполните техническую обработку по [Чек-листу (.agents/retouch-postprocessing/CHECKLIST.md)](.agents/skills/retouch-postprocessing/CHECKLIST.md).
