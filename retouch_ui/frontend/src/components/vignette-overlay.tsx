  ...
  return (
    ...
    >
      ...
      {geo.hOversizePx > 5 && (
        <>
          ...
          <text
            ...
            fill="#4488ff" fontSize={11} textAnchor="middle"
      ...
      <DragHandle
        ...
        y={geo.archTopY}
        active={dragging === "top"}
        cursor={shiftHeld ? "ns-resize" : "ns-resize"}
